 ...
 * @subpackage Example
 * @version    2.5.2 for parent theme Grafipress
...
add_action( 'tgmpa_register', 'grafipress_register_required_plugins' );
/**
 ...
 */
function grafipress_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			'name'      => 'Grafiplug',
			'slug'      => 'grafiplug',
			'source'    => 'https://github.com/Waylonf/grafiplug/archive/master.zip',
		),
	...
	$config = array(
		...
		'strings'      => array(
			...
			'installing'                      => __( 'Installing Plugin: %s', 'TEXTDOMAIN' ), // %s = plugin name.
